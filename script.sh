...
git submodule add https://github.com/rust-lang/rust.vim ./pack/plugins/start/rust.vim

git submodule add https://github.com/kyazdani42/nvim-tree.lua ./pack/plugins
